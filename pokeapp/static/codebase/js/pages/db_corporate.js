...
var DbCorporate = function() {
    // Chart.js Charts, for more examples you can check out http://www.chartjs.org/docs
    var initCorporateChartJS = function () {
        ...
        var chartCorporateLinesCon2 = jQuery('.js-chartjs-corporate-lines2');

        // Chart Variables
        var chartCorporateLines, chartCorporateLines2;
    ...
    return {
        init: function () {
            ...
            initCorporateChartJS();
        }
    };
}();

// Initialize when page loads
jQuery(function(){ DbCorporate.init(); });
